...
export const JobsView: React.FC<JobsViewProps> = ({
  ...
  useEffect(() => {
    const handleClickOutside = () => setOpenJobMenuId(null);
          ...
          {filteredJobs.length === 0 ? (
            <div className="text-center py-12 px-4 space-y-3">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 max-w-sm mx-auto">
                {search
                  ? `No jobs match "${search}". Try adjusting your search query or filters.`
            ...
            <>
              ...
              <div className="md:hidden divide-y divide-slate-100 dark:divide-slate-800/80 p-2.5 space-y-2">
                {filteredJobs.map((job) => {
                  ...
                  const tech = (staff || []).find((s) => s.id === job.assignedStaffId);
                  const isMenuOpen = openJobMenuId === job.id;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="h-7 flex items-center justify-between gap-1.5 min-w-0">
                        {/* Left: Job ID + Status Badge + Priority */}
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 h-7">
                          ...
                          <button
                            ...
                            className="w-7 h-7 flex items-center justify-center rounded-lg bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 text-indigo-600 dark:text-indigo-400 transition-colors shrink-0 cursor-pointer"
                          ...
                          <div className="relative shrink-0 flex items-center justify-center">
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                setOpenJobMenuId(isMenuOpen ? null : job.id);
                              }}
                            ...
                            {isMenuOpen && (
                              <div
                                ...
                                className="absolute right-0 top-8 z-30 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-1 animate-in fade-in zoom-in-95 text-xs text-slate-700 dark:text-slate-200"
                              >
                                <button
                                  type="button"
                                  onClick={() => {
                                ...
                                >
                                  ...
                                  <span>Dispatch to Tech (WhatsApp)</span>
                                </button>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    setOpenJobMenuId(null);
                                    sendTechnicianOnTheWayAlert(job, cust, tech, currentBusiness);
                                  }}
                                  className="w-full px-3.5 py-2 text-left hover:bg-blue-50 dark:hover:bg-blue-950/40 text-blue-700 dark:text-blue-400 font-semibold flex items-center gap-2"
                                >
                      ...
                      {/* Row 4: Scheduled Date/Time & Assigned Tech */}
                      <div className="pt-1 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400">
                        ...
                        <span className="font-medium shrink-0 ml-2">
                          {job.scheduledDate} {job.scheduledTimeSlot || job.scheduledTime || ''}
                        </span>
                      </div>
                    </div>
                  );
                ...
                <table className="w-full text-left text-xs">
                  <thead className="bg-slate-50 dark:bg-slate-800/60 text-slate-400 font-semibold uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="p-3.5 text-right">Quick Dispatch</th>
                    </tr>
                  </thead>
                    ...
                    {filteredJobs.map((job) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-3.5 text-slate-600 dark:text-slate-400 max-w-xs truncate">{job.description}</td>
